...
<a href="https://github.com/slashwhy/flutter-sdk-image/releases/tag/3.27.4"><img src="https://img.shields.io/badge/Current%20version-3.27.4-blue.svg"/></a>
...
jobs:
  build:
    docker:
      - image: slashwhyorganization/flutter-sdk-image:3.27.4
    steps:
      - checkout
      - run:
          name: Flutter Build
...
env:
  - DOCKER_IMAGE=slashwhyorganization/flutter-sdk-image:3.27.4
