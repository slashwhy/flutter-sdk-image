...
<a href="https://github.com/slashwhy/flutter-sdk-image/releases/tag/3.41.6"><img src="https://img.shields.io/badge/Current%20version-3.41.6-blue.svg"/></a>
...
jobs:
  build:
    docker:
      - image: slashwhyorganization/flutter-sdk-image:3.41.6
    steps:
      - checkout
      - run:
          name: Flutter Build
...
env:
  - DOCKER_IMAGE=slashwhyorganization/flutter-sdk-image:3.41.6
